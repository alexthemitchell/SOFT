...
happyReduction_8 (HappyTerminal (TokenStr happy_var_1))
	 =  HappyAbsSyn5
		 (EStr happy_var_1
	)
...
happyNewToken action sts stk (tk:tks) =
	...
	TokenPlus -> cont 12;
	TokenMinus -> cont 13;
	TokenAsterisk -> cont 14;
	TokenFSlash -> cont 15;
	TokenLParen -> cont 16;
	TokenRParen -> cont 17;
	TokenLBrace -> cont 18;
	TokenRBrace -> cont 19;
	TokenLSqBrkt -> cont 20;
	TokenRSqBrkt -> cont 21;
	TokenQuotation -> cont 22;
	TokenInt happy_dollar_dollar -> cont 23;
	TokenStr happy_dollar_dollar -> cont 24;
	_ -> happyError' (tk:tks)
	}
